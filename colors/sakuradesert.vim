" Name:         sakuradesert
" Description:  Light colorscheme inspired by Sakura editor.
" Author:       Takemori Kazuma
" Maintainer:   Takemori Kazuma
...
hi Normal           guifg=#000000 guibg=#fffbf0 guisp=NONE    gui=NONE      ctermfg=16 ctermbg=231 cterm=NONE    term=NONE
hi ColorColumn      guifg=#000000 guibg=#ffafaf guisp=NONE    gui=NONE      ctermfg=16 ctermbg=217 cterm=NONE    term=reverse
hi Comment          guifg=#a8a8a8 guibg=NONE    guisp=NONE    gui=italic    ctermfg=248 ctermbg=NONE    cterm=NONE    term=bold
hi Conceal          guifg=#add8e6 guibg=NONE    guisp=NONE    gui=NONE      ctermfg=153 ctermbg=NONE    cterm=NONE    term=NONE
hi Constant         guifg=#cc0000 guibg=NONE    guisp=NONE    gui=NONE      ctermfg=95 ctermbg=NONE    cterm=NONE    term=NONE
hi Cursor           guifg=#ffffff guibg=#000000 guisp=NONE    gui=NONE      ctermfg=231 ctermbg=16 cterm=NONE    term=reverse
hi CursorIM         guifg=NONE    guibg=#ff0000 guisp=NONE    gui=NONE      ctermfg=231 ctermbg=16 cterm=NONE    term=reverse
hi CursorColumn     guifg=NONE    guibg=#dadada guisp=NONE    gui=NONE      ctermfg=NONE    ctermbg=253 cterm=NONE    term=NONE
hi CursorLine       guifg=NONE    guibg=NONE    guisp=NONE    gui=underline ctermfg=NONE    ctermbg=253 cterm=NONE    term=underline
...
hi Error            guifg=#ff0000 guibg=NONE    guisp=NONE    gui=reverse   ctermfg=196 ctermbg=231 cterm=reverse term=bold,reverse
...
hi Identifier       guifg=#17008b guibg=NONE    guisp=NONE    gui=NONE      ctermfg=30 ctermbg=NONE    cterm=NONE    term=NONE
hi Ignore           guifg=NONE    guibg=NONE    guisp=NONE    gui=NONE      ctermfg=NONE    ctermbg=NONE    cterm=NONE    term=NONE
hi IncSearch        guifg=NONE    guibg=#ff9933 guisp=NONE    gui=NONE      ctermfg=30 ctermbg=226 cterm=reverse term=bold,reverse,underline
hi CurSearch        guifg=NONE    guibg=#ff9933 guisp=NONE    gui=NONE      ctermfg=30 ctermbg=226 cterm=reverse term=bold,reverse,underline
hi LineNr           guifg=#0044cc guibg=#eeeeee guisp=NONE    gui=NONE      ctermfg=243 ctermbg=NONE    cterm=NONE    term=NONE
hi MatchParen       guifg=NONE    guibg=#b3ffff guisp=NONE    gui=NONE      ctermfg=231 ctermbg=217 cterm=NONE    term=bold,underline
hi ModeMsg          guifg=#000000 guibg=NONE    guisp=NONE    gui=NONE      ctermfg=16 ctermbg=231 cterm=NONE    term=bold
hi MoreMsg          guifg=#006400 guibg=NONE    guisp=NONE    gui=NONE      ctermfg=22 ctermbg=231 cterm=NONE    term=NONE
hi NonText          guifg=#add8e6 guibg=NONE    guisp=NONE    gui=NONE      ctermfg=153 ctermbg=231 cterm=NONE    term=NONE
hi Number           guifg=#cc0000 guibg=NONE    guisp=NONE    gui=NONE      ctermfg=95 ctermbg=NONE    cterm=bold term=NONE
hi Pmenu            guifg=#000000 guibg=#dddddd guisp=NONE    gui=NONE      ctermfg=16 ctermbg=248 cterm=NONE    term=reverse
hi PmenuMatch       guifg=#ff0000 guibg=#dddddd guisp=NONE    gui=NONE      ctermfg=196 ctermbg=248 cterm=NONE    term=NONE
hi PmenuMatchSel    guifg=#ff0000 guibg=#ffff60 guisp=NONE    gui=NONE      ctermfg=196 ctermbg=228 cterm=NONE    term=NONE
hi PmenuSbar        guifg=#ffffff guibg=NONE    guisp=NONE    gui=NONE      ctermfg=231 ctermbg=231 cterm=NONE    term=reverse
...
hi Search           guifg=NONE    guibg=#ffff00 guisp=NONE    gui=NONE      ctermfg=231 ctermbg=55 cterm=NONE    term=reverse
hi SignColumn       guifg=NONE    guibg=NONE    guisp=NONE    gui=NONE      ctermfg=NONE    ctermbg=NONE    cterm=NONE    term=reverse
hi Special          guifg=#000000 guibg=NONE    guisp=NONE    gui=NONE      ctermfg=208 ctermbg=NONE    cterm=NONE    term=NONE
hi SpecialChar      guifg=#00008b guibg=NONE    guisp=NONE    gui=NONE      ctermfg=18 ctermbg=NONE    cterm=NONE    term=NONE
hi SpecialKey       guifg=#999999 guibg=NONE    guisp=NONE    gui=NONE      ctermfg=153 ctermbg=NONE    cterm=NONE    term=bold
...
hi StatusLine       guifg=#ffffff guibg=#000000 guisp=NONE    gui=NONE      ctermfg=231 ctermbg=16 cterm=bold term=bold,reverse
hi StatusLineNC     guifg=#ffffff guibg=#dddddd guisp=NONE    gui=NONE      ctermfg=231 ctermbg=248 cterm=NONE    term=bold,underline
...
hi TabLineSel       guifg=#000000 guibg=NONE    guisp=NONE    gui=bold ctermfg=16 ctermbg=231 cterm=bold term=bold,reverse
...
hi ToolbarButton    guifg=NONE    guibg=#dddddd guisp=NONE    gui=bold ctermfg=NONE    ctermbg=248 cterm=bold term=bold,reverse
hi ToolbarLine      guifg=NONE    guibg=NONE    guisp=NONE    gui=NONE    ctermfg=NONE    ctermbg=NONE    cterm=NONE    term=reverse
hi Statement        guifg=#2200cc guibg=NONE    guisp=NONE    gui=bold      ctermfg=29 ctermbg=NONE    cterm=bold term=NONE
hi Type             guifg=#0044cc guibg=NONE    guisp=NONE    gui=italic ctermfg=29 ctermbg=NONE    cterm=bold term=NONE
hi PreProc          guifg=#2200cc guibg=NONE    guisp=NONE    gui=NONE      ctermfg=55 ctermbg=NONE    cterm=NONE    term=NONE
hi Underlined       guifg=#6a0dad guibg=NONE    guisp=NONE    gui=underline ctermfg=55 ctermbg=NONE    cterm=underline term=underline
hi VertSplit        guifg=#a8a8a8 guibg=#dddddd guisp=NONE    gui=NONE    ctermfg=248 ctermbg=248 cterm=NONE    term=NONE
hi Visual           guifg=#000000 guibg=#dddddd guisp=NONE    gui=NONE    ctermfg=16 ctermbg=248 cterm=NONE    term=reverse
hi VisualNOS        guifg=NONE    guibg=NONE    guisp=NONE    gui=bold ctermfg=NONE    ctermbg=NONE    cterm=underline term=NONE
hi WarningMsg       guifg=#6a0dad guibg=NONE    guisp=NONE    gui=NONE    ctermfg=55 ctermbg=231 cterm=NONE    term=standout
...
if s:t_Co >= 16
  ...
  hi Number ctermfg=red ctermbg=NONE cterm=bold
